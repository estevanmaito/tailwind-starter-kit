...
var buttonSizesCode = "\n<button class=\"rounded-lg px-6 h-12 text-lg text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-600 focus:bg-indigo-800\">Large</button>\n<button class=\"rounded-lg px-5 h-10 text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-600 focus:bg-indigo-800\">Regular</button>\n<button class=\"rounded-lg px-4 h-8 text-sm text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-600 focus:bg-indigo-800\">Small</button>\n<a class=\"rounded-lg px-4 h-8 text-sm text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-600 focus:bg-indigo-800 inline-flex items-center\" href=\"#\">Link</a>\n<input class=\"rounded-lg px-4 h-8 text-sm text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-600 focus:bg-indigo-800 cursor-pointer\" type=\"submit\" value=\"Input\">\n";
...
//# sourceMappingURL=buttons.js.c84f86126745276acc82.hot-update.js.map