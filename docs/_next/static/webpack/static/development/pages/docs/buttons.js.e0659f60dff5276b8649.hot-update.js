...
var buttonColorsCode = "\n<button class=\"rounded-lg px-5 h-10 text-red-100 bg-red-700 focus:shadow-outline hover:bg-red-800 transition-colors duration-150\">Regular</button>\n<button class=\"rounded-lg px-5 h-10 text-green-100 bg-green-700 focus:shadow-outline hover:bg-green-800 transition-colors duration-150\">Regular</button>\n<button class=\"rounded-lg px-5 h-10 text-blue-100 bg-blue-700 focus:shadow-outline hover:bg-blue-800 transition-colors duration-150\">Regular</button>\n<button class=\"rounded-lg px-5 h-10 text-gray-100 bg-gray-700 focus:shadow-outline hover:bg-gray-800 transition-colors duration-150\">Regular</button>\n<button class=\"rounded-lg px-5 h-10 text-pink-100 bg-pink-700 focus:shadow-outline hover:bg-pink-800 transition-colors duration-150\">Regular</button>\n<button class=\"rounded-lg px-5 h-10 text-purple-100 bg-purple-700 focus:shadow-outline hover:bg-purple-800 transition-colors duration-150\">Regular</button>\n<button class=\"rounded-lg px-5 h-10 text-gray-800 bg-white focus:shadow-outline hover:bg-gray-100 transition-colors duration-150\">Regular</button>\n";
...
//# sourceMappingURL=buttons.js.e0659f60dff5276b8649.hot-update.js.map