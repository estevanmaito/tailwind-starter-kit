...
function Sidebar(_ref) {
  ...
  var navClasses = isOpen ? 'w-full fixed h-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10' : 'hidden w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10';
  return __jsx("nav", {
...
//# sourceMappingURL=alerts.js.1ff9b3fe47f8d96fbb39.hot-update.js.map