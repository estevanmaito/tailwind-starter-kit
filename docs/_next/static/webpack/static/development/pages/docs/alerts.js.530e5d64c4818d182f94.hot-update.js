...
function Sidebar(_ref) {
  ...
  var navClasses = isOpen ? 'w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10 sticky' : 'hidden w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10';
  return __jsx("nav", {
...
//# sourceMappingURL=alerts.js.530e5d64c4818d182f94.hot-update.js.map