...
var labelLeftInputCode = "\n<label class=\"text-gray-700 md:flex md:items-center\">\n  <span class=\"block mb-2 md:mb-0\">Full name</span>\n  <input class=\"md:flex-grow border rounded-lg px-3 h-10 placeholder-gray-600 text-base focus:shadow-outline\" type=\"text\" placeholder=\"Regular input\">\n</label>\n";
...
//# sourceMappingURL=forms.js.9e7e6058cff434465728.hot-update.js.map