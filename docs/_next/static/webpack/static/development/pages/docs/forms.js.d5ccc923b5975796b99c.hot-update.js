...
var labelLeftInputCode = "\n<label class=\"text-gray-700 md:flex md:items-center\">\n  <span class=\"block mb-2 md:mb-0 md:w-1/3\">Full name</span>\n  <input class=\"w-full md:w-2/3 md:flex-grow border rounded-lg px-3 h-10 placeholder-gray-600 text-base focus:shadow-outline\" type=\"text\" placeholder=\"Regular input\">\n</label>\n";
...
//# sourceMappingURL=forms.js.d5ccc923b5975796b99c.hot-update.js.map