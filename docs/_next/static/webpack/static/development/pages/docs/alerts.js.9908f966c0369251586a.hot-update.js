...
function Sidebar(_ref) {
  ...
  var navClasses = isOpen ? 'w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10' : 'hidden w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10 lg:sticky lg:h-auto';
  return __jsx("nav", {
...
//# sourceMappingURL=alerts.js.9908f966c0369251586a.hot-update.js.map