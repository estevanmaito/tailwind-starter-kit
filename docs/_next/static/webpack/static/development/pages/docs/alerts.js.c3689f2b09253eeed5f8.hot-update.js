...
function Sidebar(_ref) {
  ...
  var navClasses = isOpen ? 'w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10 lg:sticky' : 'hidden w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10';
  return __jsx("nav", {
...
//# sourceMappingURL=alerts.js.c3689f2b09253eeed5f8.hot-update.js.map