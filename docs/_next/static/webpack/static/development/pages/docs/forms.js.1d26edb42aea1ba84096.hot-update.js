...
var labelOverInputCode = "\n<div class=\"text-gray-700\">\n  <label class=\"block mb-2\" for=\"forms-labelOverInputCode\">Full name</label>\n  <input class=\"border rounded-lg px-3 h-10 placeholder-gray-600 text-base w-full focus:shadow-outline\" type=\"text\" placeholder=\"Regular input\" id=\"forms-labelOverInputCode\">\n</div>\n";
var labelLeftInputCode = "\n<div class=\"text-gray-700 md:flex md:items-center\">\n  <label class=\"block mb-2 md:mb-0 md:w-1/3\" for=\"forms-labelLeftInputCode\">Full name</label>\n  <input class=\"w-full md:w-2/3 md:flex-grow border rounded-lg px-3 h-10 placeholder-gray-600 text-base focus:shadow-outline\" type=\"text\" placeholder=\"Regular input\" id=\"forms-labelLeftInputCode\">\n</div>\n";
...
//# sourceMappingURL=forms.js.1d26edb42aea1ba84096.hot-update.js.map