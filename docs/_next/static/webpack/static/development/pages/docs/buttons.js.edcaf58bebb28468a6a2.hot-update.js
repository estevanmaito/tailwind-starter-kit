...
var buttonGroupCode = "\n<div class=\"inline-flex\">\n  <button class=\"rounded-l-lg px-5 h-10 text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-800 transition-colors duration-150\">Regular</button>\n  <button class=\"px-5 h-10 text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-800 transition-colors duration-150\">Regular</button>\n  <button class=\"rounded-r-lg px-5 h-10 text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-800 transition-colors duration-150\">Regular</button>\n</div>\n";
...
//# sourceMappingURL=buttons.js.edcaf58bebb28468a6a2.hot-update.js.map