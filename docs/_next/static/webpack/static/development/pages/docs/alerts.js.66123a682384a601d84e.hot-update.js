...
function Sidebar(_ref) {
  ...
  var navClasses = isOpen ? 'w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10 lg:sticky lg:top-16' : 'hidden w-full text-gray-600 lg:block lg:w-1/4 xl:w-1/5 bg-white z-10';
  return __jsx("nav", {
...
//# sourceMappingURL=alerts.js.66123a682384a601d84e.hot-update.js.map