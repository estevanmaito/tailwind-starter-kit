...
var buttonRightInputCode = "\n<div class=\"relative text-gray-700\">\n  <input class=\"border rounded-lg pl-3 pr-8 h-10 placeholder-gray-600 text-base w-full focus:shadow-outline\" type=\"text\" placeholder=\"Regular input\">\n  <button class=\"absolute inset-y-0 right-0 flex items-center px-4 bg-indigo-500 text-white rounded-r-lg font-bold\">Click</button>\n</div>\n";
...
//# sourceMappingURL=forms.js.1ce1ec992d117c2fbcae.hot-update.js.map