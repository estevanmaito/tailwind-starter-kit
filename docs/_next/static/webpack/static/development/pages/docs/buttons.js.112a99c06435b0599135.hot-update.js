...
var buttonSizesCode = "\n<button class=\"rounded-lg px-6 h-12 text-lg text-indigo-100 bg-indigo-700 focus:shadow-outline\">Large</button>\n<button class=\"rounded-lg px-5 h-10 text-indigo-100 bg-indigo-700 focus:shadow-outline\">Regular</button>\n<button class=\"rounded-lg px-4 h-8 text-sm text-indigo-100 bg-indigo-700 focus:shadow-outline\">Small</button>\n<a class=\"rounded-lg px-4 h-8 text-sm text-indigo-100 bg-indigo-700 focus:shadow-outline inline-flex items-center\" href=\"#\">Link</a>\n<input class=\"rounded-lg px-4 h-8 text-sm text-indigo-100 bg-indigo-700 focus:shadow-outline cursor-pointer\" type=\"submit\" value=\"Input\">\n";
...
//# sourceMappingURL=buttons.js.112a99c06435b0599135.hot-update.js.map