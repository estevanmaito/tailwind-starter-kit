...
var buttonIconRightCode = "\n<button class=\"rounded-lg px-5 h-10 text-indigo-100 bg-indigo-700 focus:shadow-outline hover:bg-indigo-800 transition-colors duration-150 inline-flex items-center\">\n  <span>Regular</span>\n  <svg class=\"fill-current h-4 w-4 ml-2\" viewBox=\"0 0 20 20\"><path d=\"M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z\" clip-rule=\"evenodd\" fill-rule=\"evenodd\"></path></svg>\n</button>\n";
...
//# sourceMappingURL=buttons.js.bc78314ab6df647bbe7d.hot-update.js.map