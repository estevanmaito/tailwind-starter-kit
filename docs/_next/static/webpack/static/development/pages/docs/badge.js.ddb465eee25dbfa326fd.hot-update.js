...
var badgeSizesCode = "\n<span class=\"rounded-full h-2 w-2 inline-block bg-red-500\"></span>\n<span class=\"rounded-full py-1 px-2 inline-flex items-center justify-center text-xs leading-none font-bold text-red-100 bg-red-700\">9</span>\n<span class=\"rounded-full py-1 px-2 inline-flex items-center justify-center text-xs leading-none font-bold text-red-100 bg-red-700\">99+</span>\n";
...
function Badge() {
  ...
  }, "Different sized badges."), __jsx(_components_CodeCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
    lang: "html",
    code: badgeSizesCode,
    __self: this,
    __source: {
...
//# sourceMappingURL=badge.js.ddb465eee25dbfa326fd.hot-update.js.map