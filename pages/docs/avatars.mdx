...
Group of stacked avatars that expand on hover. Due to a plugin, we can't do a demo in this page, but don't worry, [here's a working demo](https://play.tailwindcss.com/5en4Q10ZHq).
