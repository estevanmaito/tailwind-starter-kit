...
```jsx live
<div class="relative text-gray-700">
  <input class="w-full h-10 pl-3 pr-8 text-base placeholder-gray-600 border rounded-lg focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 focus:outline-none pr-24" type="text" placeholder="Regular input"/>
  <button class="m-1 absolute inset-y-0 right-0 flex items-center px-4 font-bold text-white bg-indigo-600 rounded-md hover:bg-indigo-500 focus:bg-indigo-700 focus:outline-none">Click</button>
</div>
```
